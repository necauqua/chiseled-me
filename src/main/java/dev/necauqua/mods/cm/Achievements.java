...
public final class Achievements extends AchievementPage {
    ...
    private static final ItemStack red = ItemRecalibrator.create(RecalibrationEffect.REDUCTION, (byte) 0);
    private static final ItemStack blue = ItemRecalibrator.create(RecalibrationEffect.AMPLIFICATION, (byte) 0);
    ...
    @SuppressWarnings("ConstantConditions") // idk why idea complains about parent being null
